...
#[::-1] разворачивает пары задом-наперед, чтобы сравнивались сначала вторые элемент.
# применяется к элементу списка, в данном случае кортежу и у него берет последний элемент
for i in grades:
